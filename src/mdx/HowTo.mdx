...
It serves as a modern digital identity solution that can be integrated into websites and mobile applications.
...
### HowTo
This little technical demo implements the OpenID Connect (OIDC) authentication for ID Austria as described [here](https://eid.egiz.gv.at/anbindung/direkte-anbindung/anbindung-oidc/).
